...
func serveHTTPPut(responseWriter http.ResponseWriter, request *http.Request, root string, authorizerFunc AuthorizerFunc, httpBodyReadSizeLimit int64, httpBodyReadTimeOut time.Duration) {
	...
	var alreadyExists bool = nil == statErr
